...
export class AddToCartComponent implements OnInit {
  ...
  addToCart(event: Event) {
    ...
    this.cartItem = {id: '1', name: 'name', color: this.selectedColor, size: this.selectedSize, quantity: this.quantity, image: '/assets/product-images/vicky-cheng-unsplash.jpg', price: 25}
